  ...
  <q-layout view="lHh Lpr lFf">
    ...
    <q-drawer v-model="drawer" show-if-above :breakpoint="500" :width="300">
      ...
      <q-img class="absolute-top" src="https://cdn.quasar.dev/img/material.png" style="height: 90px">
        <UserCard v-if="(storeMe.username)" :iconfun="goSettingsNotif" :profilefun="goProfilePage" class="absolute-top"
          :name="storeMe.username" avatar="/api/avatar/me/medium" icon="settings" size="large" nameColor="orange"
          :ratio="0.42" />
      </q-img>
